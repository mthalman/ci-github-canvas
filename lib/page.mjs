...
<body>
  ...
  <script>
    ...
    // locally and persisted together by a single Save button, so toggling a
    // checkbox is not committed until the user clicks Save. Reopening the menu
    // reloads the last-saved values, discarding any unsaved edits.
