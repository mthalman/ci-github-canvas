...
import { ARTIFACTS_DIR, NOTIFY_CONFIG_PATH } from "./constants.mjs";
...
export async function saveNotifyConfig(next) {
    ...
    try {
        // Best-effort mkdir for the artifacts dir — it doesn't exist on a
        // fresh install, so the first save is what creates it.
